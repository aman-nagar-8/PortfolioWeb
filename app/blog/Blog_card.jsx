...
const Blog_card = ({index}) => {
  ...
  return (
    <div onClick={handleclick} className='w-[300px] h-[370px] md:w-[350px] md:h-[450px] m-auto md-0 bg-zinc-100  rounded-2xl dark:bg-zinc-900  p-1 md:p-5 cursor-pointer' >
        ...
        <div className='pt-4 pl-2 md:pl-0 ' >
            <p className='text-[10px] md:text-[13px] text-zinc-600 dark:text-zinc-400' >30 Sep 2025</p>
        ...
        <div className='mt-2 pl-2  md:pl-0 flex flex-wrap gap-2' >
            {tags.map((tag , index)=>(
            <div key={index} className=' text-[9px] text-zinc-600 dark:text-zinc-300 p-1 h-5 border-[0.5px] rounded-lg border-zinc-500' >{tag}</div>
            ))}
        </div>
    </div>
  )
